import type { ChannelOnboardingAdapter, ShehzadAlgoConfig, WizardPrompter } from "shehzadalgo/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.shehzadalgo.ai/channels/mattermost",
    ].join("\n"),
