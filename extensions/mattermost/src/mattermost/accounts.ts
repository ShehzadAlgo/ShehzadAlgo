...
export function listMattermostAccountIds(cfg: ShehzadAlgoConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: ShehzadAlgoConfig): string {
...
export function listEnabledMattermostAccounts(cfg: ShehzadAlgoConfig): ResolvedMattermostAccount[] {
