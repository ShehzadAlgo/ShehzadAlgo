...
import { resolveChannelMediaMaxBytes, type ShehzadAlgoConfig } from "shehzadalgo/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: ShehzadAlgoConfig; accountId?: string }): string[] {
