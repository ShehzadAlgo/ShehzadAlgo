...
export function listBlueBubblesAccountIds(cfg: ShehzadAlgoConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: ShehzadAlgoConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: ShehzadAlgoConfig): ResolvedBlueBubblesAccount[] {
