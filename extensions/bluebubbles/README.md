...
This directory contains the **BlueBubbles external channel plugin** for shehzadalgo.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `shehzadalgo/plugin-sdk` helpers.
