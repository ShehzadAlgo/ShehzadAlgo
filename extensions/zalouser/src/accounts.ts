...
export function listZalouserAccountIds(cfg: ShehzadAlgoConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: ShehzadAlgoConfig): string {
...
function mergeZalouserAccountConfig(cfg: ShehzadAlgoConfig, accountId: string): ZalouserAccountConfig {
