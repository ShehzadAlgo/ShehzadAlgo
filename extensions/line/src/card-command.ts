import type { LineChannelData, ShehzadAlgoPluginApi, ReplyPayload } from "shehzadalgo/plugin-sdk";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: ShehzadAlgoPluginApi): void {
  api.registerCommand({
    name: "card",
