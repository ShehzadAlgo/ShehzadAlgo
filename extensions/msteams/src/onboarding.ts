...
function setMSTeamsDmPolicy(cfg: ShehzadAlgoConfig, dmPolicy: DmPolicy) {
  const allowFrom =
    dmPolicy === "open"
...
function setMSTeamsAllowFrom(cfg: ShehzadAlgoConfig, allowFrom: string[]): ShehzadAlgoConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
