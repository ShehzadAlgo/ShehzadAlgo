import type { ShehzadAlgoConfig, ShehzadAlgoPluginApi } from "shehzadalgo/plugin-sdk";
...
function resolveOwnershipAgent(config: ShehzadAlgoConfig): { id: string; name: string } {
