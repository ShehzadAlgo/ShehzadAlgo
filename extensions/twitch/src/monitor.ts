...
import type { ReplyPayload, ShehzadAlgoConfig } from "shehzadalgo/plugin-sdk";
import { createReplyPrefixOptions } from "shehzadalgo/plugin-sdk";
...
export type TwitchMonitorOptions = {
  ...
  accountId: string;
  config: unknown; // ShehzadAlgoConfig
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as ShehzadAlgoConfig;
