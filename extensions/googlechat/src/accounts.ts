...
export function listGoogleChatAccountIds(cfg: ShehzadAlgoConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: ShehzadAlgoConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: ShehzadAlgoConfig): ResolvedGoogleChatAccount[] {
