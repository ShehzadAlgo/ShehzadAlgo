...
Nostr DM channel plugin for shehzadalgo using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to shehzadalgo. It enables your bot to:
...
# Configure shehzadalgo to use local relay
