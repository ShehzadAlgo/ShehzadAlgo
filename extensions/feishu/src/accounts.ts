...
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "shehzadalgo/plugin-sdk/account-id";
import type {
  FeishuConfig,
  FeishuAccountConfig,
  FeishuDomain,
 ...
 */
export function listFeishuAccountIds(cfg: shehzadalgoConfig): string[] {
 ...
 */
export function resolveDefaultFeishuAccountId(cfg: shehzadalgoConfig): string {
 ...
 */
function mergeFeishuAccountConfig(cfg: shehzadalgoConfig, accountId: string): FeishuConfig {
 ...
 */
export function listEnabledFeishuAccounts(cfg: shehzadalgoConfig): ResolvedFeishuAccount[] {
