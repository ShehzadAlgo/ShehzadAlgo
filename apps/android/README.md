## ShehzadAlgo Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_shehzadalgo-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm shehzadalgo gateway --port 18789 --verbose
```
