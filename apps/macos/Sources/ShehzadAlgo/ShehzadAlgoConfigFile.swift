...
enum ShehzadAlgoConfigFile {
    private static let logger = Logger(subsystem: "ai.shehzadalgo", category: "config")
    ...
    static func stateDirURL() -> URL {
        ShehzadAlgoPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        ShehzadAlgoPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-shehzadalgo-config-file",
            "event": "config.write",
