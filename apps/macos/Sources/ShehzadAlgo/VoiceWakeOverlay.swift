...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.shehzadalgo", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other ShehzadAlgo windows, but below the system’s pop-up menus.
