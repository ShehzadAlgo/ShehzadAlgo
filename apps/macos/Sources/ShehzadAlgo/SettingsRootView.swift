...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .shehzadalgoSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? ShehzadAlgoPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? ShehzadAlgoPaths.stateDirURL.path
...
extension Notification.Name {
    static let shehzadalgoSelectSettingsTab = Notification.Name("shehzadalgoSelectSettingsTab")
}
