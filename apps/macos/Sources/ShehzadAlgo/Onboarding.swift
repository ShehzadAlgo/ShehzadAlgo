...
enum UIStrings {
    static let welcomeTitle = "Welcome to ShehzadAlgo"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "shehzadalgo.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: ShehzadAlgoOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: ShehzadAlgoChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g shehzadalgo@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: ShehzadAlgoChatViewModel(
