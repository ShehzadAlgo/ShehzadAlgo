...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.shehzadalgo", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return ShehzadAlgoConfigFile.defaultWorkspaceURL() }
    ...
    static func defaultTemplate() -> String {
        let fallback = """
        # AGENTS.md - ShehzadAlgo Workspace
    ...
    static func defaultBootstrapTemplate() -> String {
        ...
        3) ~/.shehzadalgo/shehzadalgo.json
