...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.shehzadalgo", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("ShehzadAlgo/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__shehzadalgo__/a2ui/").absoluteString + "?platform=macos"
    }
