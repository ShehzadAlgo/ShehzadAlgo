...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/shehzadalgo/shehzadalgo") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/shehzadalgo/shehzadalgo")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://shehzadalgo.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "ShehzadAlgoBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "ShehzadAlgoBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "ShehzadAlgoGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "ShehzadAlgoGitCommit") as? String) ??
            "unknown"
    }
