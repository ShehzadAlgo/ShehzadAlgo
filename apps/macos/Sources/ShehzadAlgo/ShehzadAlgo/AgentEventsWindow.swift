...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: ShehzadAlgoProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": ShehzadAlgoProtocol.AnyCodable("start"),
                "name": ShehzadAlgoProtocol.AnyCodable("bash"),
            ],
            summary: nil)
