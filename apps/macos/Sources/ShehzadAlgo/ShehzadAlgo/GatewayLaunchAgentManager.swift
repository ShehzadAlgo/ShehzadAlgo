...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.shehzadalgo", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".shehzadalgo/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.shehzadalgoCommand(
            subcommand: "gateway",
