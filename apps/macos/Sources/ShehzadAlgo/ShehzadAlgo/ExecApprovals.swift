...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.shehzadalgo", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        ShehzadAlgoPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        ShehzadAlgoPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
