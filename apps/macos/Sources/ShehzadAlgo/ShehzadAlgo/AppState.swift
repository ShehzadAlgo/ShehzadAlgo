...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = ShehzadAlgoConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = ShehzadAlgoConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = ShehzadAlgoConfigFile.loadDict()
            ...
            ShehzadAlgoConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/shehzadalgo"
        state.remoteCliPath = ""
        return state
    }
}
