...
enum AnthropicAuthMode: Equatable {
    ...
    var shortLabel: String {
        switch self {
        case .oauthFile: "OAuth (ShehzadAlgo token file)"
...
enum AnthropicAuthResolver {
    static func resolve(
        ...
        oauthStatus: ShehzadAlgoOAuthStore.AnthropicOAuthStatus = ShehzadAlgoOAuthStore
...
enum AnthropicOAuth {
    private static let logger = Logger(subsystem: "ai.shehzadalgo", category: "anthropic-oauth")
...
enum ShehzadAlgoOAuthStore {
    static let oauthFilename = "oauth.json"
    private static let providerKey = "anthropic"
    private static let shehzadalgoOAuthDirEnv = "SHEHZADALGO_OAUTH_DIR"
    ...
    enum AnthropicOAuthStatus: Equatable {
        ...
        var shortDescription: String {
            switch self {
            case .missingFile: "ShehzadAlgo OAuth token file not found"
            case .unreadableFile: "ShehzadAlgo OAuth token file not readable"
            case .invalidJSON: "ShehzadAlgo OAuth token file invalid"
            case .missingProviderEntry: "No Anthropic entry in ShehzadAlgo OAuth token file"
            case .missingTokens: "Anthropic entry missing tokens"
            case .connected: "ShehzadAlgo OAuth credentials found"
            }
        }
    }

    static func oauthDir() -> URL {
        if let override = ProcessInfo.processInfo.environment[self.shehzadalgoOAuthDirEnv]?
        ...
        return home.appendingPathComponent(".shehzadalgo", isDirectory: true)
