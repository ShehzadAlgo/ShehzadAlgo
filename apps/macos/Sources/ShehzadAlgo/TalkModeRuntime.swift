...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.shehzadalgo", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.shehzadalgo", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [ShehzadAlgoChatMessage] = messages.compactMap { item in
