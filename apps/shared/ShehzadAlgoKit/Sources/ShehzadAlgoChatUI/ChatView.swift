...
@MainActor
public struct ShehzadAlgoChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: ShehzadAlgoChatViewModel
    ...
    public init(
        viewModel: ShehzadAlgoChatViewModel,
    ...
    public var body: some View {
        ZStack {
            if self.style == .standard {
                ShehzadAlgoChatTheme.background
                    .ignoresSafeArea()
            }
    ...
    private var visibleMessages: [ShehzadAlgoChatMessage] {
        let base: [ShehzadAlgoChatMessage]
    ...
    private func mergeToolResults(in messages: [ShehzadAlgoChatMessage]) -> [ShehzadAlgoChatMessage] {
        ...
        for message in messages {
            ...
            let merged = ShehzadAlgoChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: ShehzadAlgoChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: ShehzadAlgoChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: ShehzadAlgoChatMessage) -> String {
