...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.shehzadalgo", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.shehzadalgo", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: ShehzadAlgoProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
