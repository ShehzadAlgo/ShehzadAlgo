...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = ShehzadAlgoChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = ShehzadAlgoChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
