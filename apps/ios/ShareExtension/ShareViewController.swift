...
final class ShareViewController: UIViewController {
    ...
    private let logger = Logger(subsystem: "ai.shehzadalgo.ios", category: "ShareExtension")
    ...
    private func setupUI() {
        ...
        self.sendButton.setTitle("Send to ShehzadAlgo", for: .normal)
    ...
    private func sendCurrentDraft() async {
        ...
        self.showStatus("Sending to ShehzadAlgo gateway…")
        ...
        do {
            ...
            self.showStatus("Sent to ShehzadAlgo.")
    ...
    private func sendMessageToGateway(_ message: String, attachments: [ShareAttachment]) async throws {
        guard let config = ShareGatewayRelaySettings.loadConfig() else {
            throw NSError(
                domain: "ShehzadAlgoShare",
                code: 10,
                userInfo: [NSLocalizedDescriptionKey: "ShehzadAlgo is not connected to a gateway yet."])
        }
        ...
        let makeOptions: (String) -> GatewayConnectOptions = { clientId in
            GatewayConnectOptions(
                ...
                clientId: clientId,
                clientMode: "node",
                clientDisplayName: "ShehzadAlgo Share",
        ...
        do {
            try await gateway.connect(
                ...
                connectOptions: makeOptions("shehzadalgo-ios"),
                sessionBox: nil,
                onConnected: {},
                onDisconnected: { _ in },
                onInvoke: { req in
