...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.shehzadalgo.gateway"
    private static let nodeService = "ai.shehzadalgo.node"
    private static let talkService = "ai.shehzadalgo.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.shehzadalgo.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.shehzadalgo.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appendingPathComponent("shehzadalgo-gateway.log")
    }
