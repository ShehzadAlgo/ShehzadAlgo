...
actor CameraController {
    ...
    func snap(params: ShehzadAlgoCameraSnapParams) async throws -> (
        format: String,
        base64: String,
        width: Int,
        height: Int)
    ...
    func clip(params: ShehzadAlgoCameraClipParams) async throws -> (
        format: String,
        base64: String,
        durationMs: Int,
        hasAudio: Bool)
    {
        ...
        let movURL = FileManager().temporaryDirectory
            .appendingPathComponent("shehzadalgo-camera-\(UUID().uuidString).mov")
        let mp4URL = FileManager().temporaryDirectory
            .appendingPathComponent("shehzadalgo-camera-\(UUID().uuidString).mp4")
    ...
    private nonisolated static func pickCamera(
        facing: ShehzadAlgoCameraFacing,
