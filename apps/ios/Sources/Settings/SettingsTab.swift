...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = ShehzadAlgoLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = ShehzadAlgoLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.shehzadalgo.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        self.featureToggle(
                            ...
                            help: "Enables voice conversation mode with your connected ShehzadAlgo agent.") { newValue in
                        ...
                        self.featureToggle(
                            ...
                            help: "Allows the gateway to request photos or short video clips while ShehzadAlgo is foregrounded.")
                        ...
                        HStack(spacing: 8) {
                            ...
                            Button {
                                self.activeFeatureHelp = FeatureHelp(
                                    ...
                                    message: "Controls location permissions for ShehzadAlgo. Off disables location tools, While Using enables foreground location, and Always enables background location.")
                            } label: {
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(ShehzadAlgoLocationMode.off.rawValue)
                            Text("While Using").tag(ShehzadAlgoLocationMode.whileUsing.rawValue)
                            Text("Always").tag(ShehzadAlgoLocationMode.always.rawValue)
                        }
                        .labelsHidden()
                        ...
                        self.featureToggle(
                            ...
                            help: "Keeps the screen awake while ShehzadAlgo is open.")
                            ...
                            HStack(spacing: 8) {
                                ...
                                Button {
                                    self.activeFeatureHelp = FeatureHelp(
                                        ...
                                        message: "Appends this instruction when sharing content into ShehzadAlgo from iOS.")
                                } label: {
                                    Image(systemName: "info.circle")
                                        .foregroundStyle(.secondary)
                                }
                    ...
                    DisclosureGroup("Device Info") {
                        ...
                        LabeledContent("ShehzadAlgo", value: self.shehzadAlgoVersionString())
                    }
                }
            }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = ShehzadAlgoLocationMode(rawValue: newValue) else { return }
                Task {
    ...
    private func shehzadAlgoVersionString() -> String {
