...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: ShehzadAlgoPhotosLatestParams) async throws -> ShehzadAlgoPhotosLatestPayload {
        ...
        var results: [ShehzadAlgoPhotoPayload] = []
        ...
        return ShehzadAlgoPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> ShehzadAlgoPhotoPayload
    {
        ...
        return ShehzadAlgoPhotoPayload(
            format: "jpeg",
