...
final class ScreenController {
    ...
    /// Callback invoked when an shehzadalgo:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = ShehzadAlgoKitResources.bundle
...
/// Handles navigation policy to intercept shehzadalgo:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept shehzadalgo:// deep links.
        if url.scheme?.lowercased() == "shehzadalgo" {
...
private final class CanvasA2UIActionMessageHandler: NSObject, WKScriptMessageHandler {
    static let messageName = "shehzadalgoCanvasA2UIAction"
