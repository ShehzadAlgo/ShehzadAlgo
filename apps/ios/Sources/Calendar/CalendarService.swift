...
final class CalendarService: CalendarServicing {
    func events(params: ShehzadAlgoCalendarEventsParams) async throws -> ShehzadAlgoCalendarEventsPayload {
        ...
        let payload = selected.map { event in
            ShehzadAlgoCalendarEventPayload(
        ...
        return ShehzadAlgoCalendarEventsPayload(events: payload)
    }
    ...
    func add(params: ShehzadAlgoCalendarAddParams) async throws -> ShehzadAlgoCalendarAddPayload {
        ...
        let payload = ShehzadAlgoCalendarEventPayload(
            identifier: event.eventIdentifier ?? UUID().uuidString,
        ...
        return ShehzadAlgoCalendarAddPayload(event: payload)
    }
