    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["shehzadalgo channels list", "List configured channels and auth profiles."],
          ["shehzadalgo channels status --probe", "Run channel status checks and probes."],
          [
            "shehzadalgo channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["shehzadalgo channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.shehzadalgo.ai/cli/channels",
        )}\n`,
    );
