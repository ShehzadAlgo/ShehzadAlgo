...
describe("setupOnboardingShellCompletion", () => {
  it("QuickStart: installs without prompting", async () => {
    ...
    expect(deps.ensureCompletionCacheExists).toHaveBeenCalledWith("shehzadalgo");
    expect(deps.installCompletion).toHaveBeenCalledWith("zsh", true, "shehzadalgo");
