...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/shehzadalgo/shehzadalgo/issues/15692
   */
  delivered?: boolean;
} & CronRunOutcome &
  CronRunTelemetry;
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.SHEHZADALGO_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.shehzadalgo/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: ShehzadAlgoConfig = {
    ...params.cfg,
