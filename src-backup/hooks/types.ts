...
export type ShehzadAlgoHookMetadata = {
  always?: boolean;
  hookKey?: string;
  emoji?: string;
  homepage?: string;
...
export type Hook = {
  name: string;
  description: string;
  source: "shehzadalgo-bundled" | "shehzadalgo-managed" | "shehzadalgo-workspace" | "shehzadalgo-plugin";
  pluginId?: string;
...
export type HookEntry = {
  ...
  metadata?: ShehzadAlgoHookMetadata;
