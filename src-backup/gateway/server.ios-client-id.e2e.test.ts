...
beforeAll(async () => {
  previousToken = process.env.SHEHZADALGO_GATEWAY_TOKEN;
  process.env.SHEHZADALGO_GATEWAY_TOKEN = "test-gateway-token-1234567890";
...
test.each([
  { clientId: "shehzadalgo-ios", platform: "ios" },
  { clientId: "shehzadalgo-android", platform: "android" },
