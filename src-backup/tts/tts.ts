...
export function resolveTtsConfig(cfg: ShehzadAlgoConfig): ResolvedTtsConfig {
...
export function resolveTtsPrefsPath(config: ResolvedTtsConfig): string {
  ...
  const envPath = process.env.SHEHZADALGO_TTS_PREFS?.trim();
  if (envPath) {
...
export function buildTtsSystemPromptHint(cfg: ShehzadAlgoConfig): string | undefined {
