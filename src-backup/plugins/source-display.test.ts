...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/shehzadalgo/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/shehzadalgo/extensions",
        global: "/Users/x/.shehzadalgo/extensions",
        workspace: "/Users/x/ws/.shehzadalgo/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.shehzadalgo/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/shehzadalgo/extensions",
        global: "/Users/x/.shehzadalgo/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.shehzadalgo/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/shehzadalgo/extensions",
        global: "/Users/x/.shehzadalgo/extensions",
