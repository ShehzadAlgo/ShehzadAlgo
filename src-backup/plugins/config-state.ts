...
export const normalizePluginsConfig = (
  config?: ShehzadAlgoConfig["plugins"],
...
const hasExplicitMemorySlot = (plugins?: ShehzadAlgoConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: ShehzadAlgoConfig["plugins"]) =>
  Boolean(plugins?.entries && Object.prototype.hasOwnProperty.call(plugins.entries, "memory-core"));

const hasExplicitPluginConfig = (plugins?: ShehzadAlgoConfig["plugins"]) => {
  if (!plugins) {
    return false;
  }
