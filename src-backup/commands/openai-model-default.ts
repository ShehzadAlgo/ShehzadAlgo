...
export function applyOpenAIProviderConfig(cfg: ShehzadAlgoConfig): ShehzadAlgoConfig {
...
export function applyOpenAIConfig(cfg: ShehzadAlgoConfig): ShehzadAlgoConfig {
