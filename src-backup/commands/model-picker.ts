...
type PromptDefaultModelResult = { model?: string; config?: ShehzadAlgoConfig };
...
function resolveConfiguredModelRaw(cfg: ShehzadAlgoConfig): string {
...
function resolveConfiguredModelKeys(cfg: ShehzadAlgoConfig): string[] {
...
export function applyPrimaryModel(cfg: ShehzadAlgoConfig, model: string): ShehzadAlgoConfig {
...
export function applyModelAllowlist(cfg: ShehzadAlgoConfig, models: string[]): ShehzadAlgoConfig {
  const defaults = cfg.agents?.defaults;
