...
export function summarizeExistingConfig(config: ShehzadAlgoConfig): string {
  const rows: string[] = [];
...
export function formatControlUiSshHint(params: {
  ...
  return [
    ...
    authedUrl,
    "Docs:",
    "https://docs.shehzadalgo.ai/gateway/remote",
    "https://docs.shehzadalgo.ai/web/control-ui",
  ]
    .filter(Boolean)
    .join("\n");
}
