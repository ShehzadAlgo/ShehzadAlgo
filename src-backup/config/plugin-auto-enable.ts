...
function isTelegramConfigured(cfg: ShehzadAlgoConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: ShehzadAlgoConfig, env: NodeJS.ProcessEnv): boolean {
...
function isIrcConfigured(cfg: ShehzadAlgoConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: ShehzadAlgoConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: ShehzadAlgoConfig): boolean {
...
function isIMessageConfigured(cfg: ShehzadAlgoConfig): boolean {
...
function isWhatsAppConfigured(cfg: ShehzadAlgoConfig): boolean {
...
function isGenericChannelConfigured(cfg: ShehzadAlgoConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: ShehzadAlgoConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: ShehzadAlgoConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: ShehzadAlgoConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: ShehzadAlgoConfig, pluginId: string): boolean {
...
function registerPluginEntry(cfg: ShehzadAlgoConfig, pluginId: string): ShehzadAlgoConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
