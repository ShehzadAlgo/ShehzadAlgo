...
function resolveAnthropicDefaultAuthMode(cfg: ShehzadAlgoConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: ShehzadAlgoConfig): ShehzadAlgoConfig {
...
export function applyTalkApiKey(config: ShehzadAlgoConfig): ShehzadAlgoConfig {
...
export function applyModelDefaults(cfg: ShehzadAlgoConfig): ShehzadAlgoConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: ShehzadAlgoConfig): ShehzadAlgoConfig {
...
export function applyLoggingDefaults(cfg: ShehzadAlgoConfig): ShehzadAlgoConfig {
...
export function applyContextPruningDefaults(cfg: ShehzadAlgoConfig): ShehzadAlgoConfig {
...
export function applyCompactionDefaults(cfg: ShehzadAlgoConfig): ShehzadAlgoConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
