...
const CLEANUP_STATE_KEY = Symbol.for("shehzadalgo.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("shehzadalgo.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("shehzadalgo.sessionWriteLockWatchdogState");
