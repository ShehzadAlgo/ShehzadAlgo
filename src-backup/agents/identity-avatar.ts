...
function resolveAvatarSource(cfg: ShehzadAlgoConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: ShehzadAlgoConfig, agentId: string): AgentAvatarResolution {
