...
export function applyMinimaxProviderConfig(cfg: ShehzadAlgoConfig): ShehzadAlgoConfig {
...
export function applyMinimaxConfig(cfg: ShehzadAlgoConfig): ShehzadAlgoConfig {
