...
export async function statusCommand(
  ...
  runtime.log(theme.heading("ShehzadAlgo status"));
  runtime.log("");
  ...
  runtime.log(theme.muted(`Full report: ${formatCliCommand("shehzadalgo security audit")}`));
  runtime.log(theme.muted(`Deep probe: ${formatCliCommand("shehzadalgo security audit --deep")}`));
  ...
  runtime.log("");
  runtime.log("FAQ: https://docs.shehzadalgo.ai/faq");
  runtime.log("Troubleshooting: https://docs.shehzadalgo.ai/troubleshooting");
  runtime.log("");
  ...
  runtime.log(`  Need to share?      ${formatCliCommand("shehzadalgo status --all")}`);
  runtime.log(`  Need to debug live? ${formatCliCommand("shehzadalgo logs --follow")}`);
  if (gatewayReachable) {
    runtime.log(`  Need to test channels? ${formatCliCommand("shehzadalgo status --deep")}`);
  } else {
    runtime.log(`  Fix reachability first: ${formatCliCommand("shehzadalgo gateway probe")}`);
  }
}
