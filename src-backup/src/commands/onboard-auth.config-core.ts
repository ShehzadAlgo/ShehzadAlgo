...
export function applyOpenrouterProviderConfig(cfg: ShehzadAlgoConfig): ShehzadAlgoConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: ShehzadAlgoConfig): ShehzadAlgoConfig {
  const next = applyOpenrouterProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, OPENROUTER_DEFAULT_MODEL_REF);
}

export function applyMoonshotProviderConfig(cfg: ShehzadAlgoConfig): ShehzadAlgoConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: ShehzadAlgoConfig): ShehzadAlgoConfig {
...
export function applyMoonshotConfig(cfg: ShehzadAlgoConfig): ShehzadAlgoConfig {
  const next = applyMoonshotProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyMoonshotConfigCn(cfg: ShehzadAlgoConfig): ShehzadAlgoConfig {
  const next = applyMoonshotProviderConfigCn(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyKimiCodeProviderConfig(cfg: ShehzadAlgoConfig): ShehzadAlgoConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: ShehzadAlgoConfig): ShehzadAlgoConfig {
  const next = applyKimiCodeProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, KIMI_CODING_MODEL_REF);
}

export function applySyntheticProviderConfig(cfg: ShehzadAlgoConfig): ShehzadAlgoConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: ShehzadAlgoConfig): ShehzadAlgoConfig {
  const next = applySyntheticProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, SYNTHETIC_DEFAULT_MODEL_REF);
}

export function applyXiaomiProviderConfig(cfg: ShehzadAlgoConfig): ShehzadAlgoConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: ShehzadAlgoConfig): ShehzadAlgoConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: ShehzadAlgoConfig): ShehzadAlgoConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: ShehzadAlgoConfig): ShehzadAlgoConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: ShehzadAlgoConfig): ShehzadAlgoConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: ShehzadAlgoConfig): ShehzadAlgoConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: ShehzadAlgoConfig): ShehzadAlgoConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: ShehzadAlgoConfig): ShehzadAlgoConfig {
  const next = applyHuggingfaceProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, HUGGINGFACE_DEFAULT_MODEL_REF);
}

export function applyXaiProviderConfig(cfg: ShehzadAlgoConfig): ShehzadAlgoConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: ShehzadAlgoConfig): ShehzadAlgoConfig {
...
export function applyQianfanProviderConfig(cfg: ShehzadAlgoConfig): ShehzadAlgoConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: ShehzadAlgoConfig): ShehzadAlgoConfig {
