...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.shehzadalgo.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("shehzadalgo hooks list")}`,
      `  ${formatCliCommand("shehzadalgo hooks enable <name>")}`,
      `  ${formatCliCommand("shehzadalgo hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
