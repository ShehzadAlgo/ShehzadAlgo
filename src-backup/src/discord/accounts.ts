...
function mergeDiscordAccountConfig(cfg: ShehzadAlgoConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: ShehzadAlgoConfig): ResolvedDiscordAccount[] {
