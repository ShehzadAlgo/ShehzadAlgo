...
import { createShehzadAlgoTools } from "../agents/shehzadalgo-tools.js";
import {
...
export async function handleToolsInvokeHttpRequest(
  ...
  const messageChannel = normalizeMessageChannel(
    getHeader(req, "x-shehzadalgo-message-channel") ?? "",
  );
  const accountId = getHeader(req, "x-shehzadalgo-account-id")?.trim() || undefined;
  ...
  const allTools = createShehzadAlgoTools({
