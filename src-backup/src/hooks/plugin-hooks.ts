...
import type { ShehzadAlgoPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: ShehzadAlgoPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: ShehzadAlgoPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
