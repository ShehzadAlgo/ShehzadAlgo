...
describe("loader", () => {
  ...
  beforeAll(async () => {
    fixtureRoot = await fs.mkdtemp(path.join(os.tmpdir(), "shehzadalgo-hooks-loader-"));
  });
  ...
  beforeEach(async () => {
    ...
    originalBundledDir = process.env.SHEHZADALGO_BUNDLED_HOOKS_DIR;
    process.env.SHEHZADALGO_BUNDLED_HOOKS_DIR = "/nonexistent/bundled/hooks";
  });
  ...
  afterEach(async () => {
    ...
    if (originalBundledDir === undefined) {
      delete process.env.SHEHZADALGO_BUNDLED_HOOKS_DIR;
    } else {
      process.env.SHEHZADALGO_BUNDLED_HOOKS_DIR = originalBundledDir;
    }
  });
