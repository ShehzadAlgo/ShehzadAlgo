...
export function resolveSessionToolsVisibility(cfg: ShehzadAlgoConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: ShehzadAlgoConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: ShehzadAlgoConfig): AgentToAgentPolicy {
