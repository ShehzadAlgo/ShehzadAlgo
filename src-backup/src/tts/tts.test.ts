...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.SHEHZADALGO_TTS_PREFS;
      process.env.SHEHZADALGO_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.SHEHZADALGO_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: ShehzadAlgoConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,
