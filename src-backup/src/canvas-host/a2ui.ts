...
export const A2UI_PATH = "/__shehzadalgo__/a2ui";

export const CANVAS_HOST_PATH = "/__shehzadalgo__/canvas";

export const CANVAS_WS_PATH = "/__shehzadalgo__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.shehzadalgoCanvasA2UIAction.postMessage(...)
  // - Android: window.shehzadalgoCanvasA2UIAction.postMessage(...)
  const handlerNames = ["shehzadalgoCanvasA2UIAction"];
  ...
  globalThis.ShehzadAlgo = globalThis.ShehzadAlgo ?? {};
  globalThis.ShehzadAlgo.postMessage = postToNode;
  globalThis.ShehzadAlgo.sendUserAction = sendUserAction;
  globalThis.shehzadalgoPostMessage = postToNode;
  globalThis.shehzadalgoSendUserAction = sendUserAction;
