    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["shehzadalgo directory self --channel slack", "Show the connected account identity."],
          [
            'shehzadalgo directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["shehzadalgo directory groups list --channel discord", "List available groups/channels."],
          [
            "shehzadalgo directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.shehzadalgo.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
