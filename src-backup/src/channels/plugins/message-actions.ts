...
export function listChannelMessageActions(cfg: ShehzadAlgoConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: ShehzadAlgoConfig): boolean {
  for (const plugin of listChannelPlugins()) {
...
export function supportsChannelMessageCards(cfg: ShehzadAlgoConfig): boolean {
  for (const plugin of listChannelPlugins()) {
