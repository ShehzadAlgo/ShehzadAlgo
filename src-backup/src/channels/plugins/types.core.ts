...
export type ChannelAgentToolFactory = (params: { cfg?: ShehzadAlgoConfig }) => ChannelAgentTool[];
...
export type ChannelMentionAdapter = {
  stripPatterns?: (params: {
    ctx: MsgContext;
    cfg: ShehzadAlgoConfig | undefined;
    agentId?: string;
  }) => string[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: ShehzadAlgoConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: ShehzadAlgoConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: ShehzadAlgoConfig }) => boolean;
  supportsCards?: (params: { cfg: ShehzadAlgoConfig }) => boolean;
