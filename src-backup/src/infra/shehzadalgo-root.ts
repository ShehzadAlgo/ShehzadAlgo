...
const CORE_PACKAGE_NAMES = new Set(["shehzadalgo"]);
...
export async function resolveShehzadAlgoPackageRoot(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): Promise<string | null> {
...
export function resolveShehzadAlgoPackageRootSync(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): string | null {
