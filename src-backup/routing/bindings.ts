...
export function listBindings(cfg: ShehzadAlgoConfig): AgentBinding[] {
...
export function listBoundAccountIds(cfg: ShehzadAlgoConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: ShehzadAlgoConfig) {
