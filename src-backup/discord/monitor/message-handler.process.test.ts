...
const resolveStorePath = vi.fn(() => "/tmp/shehzadalgo-discord-process-test-sessions.json");
...
beforeEach(() => {
  ...
  resolveStorePath.mockReturnValue("/tmp/shehzadalgo-discord-process-test-sessions.json");
});
