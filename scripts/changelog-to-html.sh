...
if [[ -z "$version_content" ]]; then
  echo "<h2>ShehzadAlgo $VERSION</h2>"
  echo "<p>Latest ShehzadAlgo update.</p>"
  echo "<p><a href=\"https://github.com/shehzadalgo/shehzadalgo/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
