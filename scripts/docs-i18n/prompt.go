...
- Keep product names in English: ShehzadAlgo, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the ShehzadAlgo Gateway, use “Gateway 网关”.
