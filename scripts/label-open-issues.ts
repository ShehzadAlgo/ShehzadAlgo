...
const STATE_FILE_PATH = join(CONFIG_BASE_DIR, "shehzadalgo", STATE_FILE_NAME);
      ...
      input: [
        {
          role: "system",
          content:
            "You classify GitHub issues and pull requests for ShehzadAlgo. Respond with JSON only, no extra text.",
        },
        {
          role: "user",
          content: [
...
async function main() {
  ...
  logHeader("ShehzadAlgo Issue Label Audit");
