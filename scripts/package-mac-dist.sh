...
# - dist/ShehzadAlgo-<version>.zip
# - dist/ShehzadAlgo-<version>.dmg
...
APP="$ROOT_DIR/dist/ShehzadAlgo.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/ShehzadAlgo-$VERSION.zip"
DMG="$ROOT_DIR/dist/ShehzadAlgo-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/ShehzadAlgo-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/ShehzadAlgo-$VERSION.dSYM.zip"
