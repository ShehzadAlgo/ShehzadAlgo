...
This guide summarizes a sane workflow for working on the pi integration in ShehzadAlgo.
...
- Trigger the agent directly:
  - `pnpm shehzadalgo agent --message "Hello" --thinking low`
...
State lives under the ShehzadAlgo state directory. Default is `~/.shehzadalgo`. If `SHEHZADALGO_STATE_DIR` is set, use that directory instead.

To reset everything:

- `shehzadalgo.json` for config
...
- [https://docs.shehzadalgo.ai/testing](https://docs.shehzadalgo.ai/testing)
- [https://docs.shehzadalgo.ai/start/getting-started](https://docs.shehzadalgo.ai/start/getting-started)
