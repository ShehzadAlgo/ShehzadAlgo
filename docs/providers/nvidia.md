---
summary: "Use NVIDIA's OpenAI-compatible API in ShehzadAlgo"
read_when:
  - You want to use NVIDIA models in ShehzadAlgo
...
shehzadalgo onboard --auth-choice skip
shehzadalgo models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
