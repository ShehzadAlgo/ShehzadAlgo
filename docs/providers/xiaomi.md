---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with ShehzadAlgo"
read_when:
  - You want Xiaomi MiMo models in ShehzadAlgo
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). ShehzadAlgo uses
