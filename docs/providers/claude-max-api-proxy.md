...
You can point ShehzadAlgo at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or ShehzadAlgo
...
- [Anthropic provider](/providers/anthropic) - Native ShehzadAlgo integration with Claude setup-token or API keys
