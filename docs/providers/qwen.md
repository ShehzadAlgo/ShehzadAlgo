---
summary: "Use Qwen OAuth (free tier) in ShehzadAlgo"
read_when:
  - You want to use Qwen with ShehzadAlgo
...
If you already logged in with the Qwen Code CLI, ShehzadAlgo will sync credentials
