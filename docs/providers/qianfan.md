---
summary: "Use Qianfan's unified API to access many models in ShehzadAlgo"
read_when:
...
3. ShehzadAlgo installed on your system
...
4. Copy the API key for use with ShehzadAlgo

## CLI setup

```bash
shehzadalgo onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [ShehzadAlgo Configuration](/gateway/configuration)
