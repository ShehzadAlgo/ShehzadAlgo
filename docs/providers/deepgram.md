...
Deepgram is a speech-to-text API. In ShehzadAlgo it is used for **inbound audio/voice note
transcription** via `tools.media.audio`.

When enabled, ShehzadAlgo uploads the audio file to Deepgram and injects the transcript
