---
summary: "Use Synthetic's Anthropic-compatible API in ShehzadAlgo"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. ShehzadAlgo registers it as the
...
Note: ShehzadAlgo's Anthropic client appends `/v1` to the base URL, so use
