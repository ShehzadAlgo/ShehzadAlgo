...
read_when:
  - You want ShehzadAlgo to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables ShehzadAlgo to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`shehzadalgo onboard`) and `shehzadalgo channels add` list optional channel plugins.
...
```bash
shehzadalgo plugins install @shehzadalgo/nostr
```

Use a local checkout (dev workflows):

```bash
shehzadalgo plugins install --link <path-to-shehzadalgo>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "shehzadalgo",
        "displayName": "ShehzadAlgo",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "shehzadalgo@example.com",
        "lud16": "shehzadalgo@example.com"
      }
    }
  }
}
