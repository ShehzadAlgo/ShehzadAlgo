...
- Install via CLI: `shehzadalgo plugins install @shehzadalgo/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `shehzadalgo plugins install ./extensions/zalo`
   - From npm (if published): `shehzadalgo plugins install @shehzadalgo/zalo`
...
- Approve via:
  - `shehzadalgo pairing list zalo`
  - `shehzadalgo pairing approve zalo <CODE>`
...
- Example: `shehzadalgo message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `shehzadalgo channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `shehzadalgo logs --follow`
