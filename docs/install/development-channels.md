...
ShehzadAlgo ships three update channels:
...
When you **explicitly** switch channels with `--channel`, ShehzadAlgo also aligns
the install method:
...
When you switch channels with `shehzadalgo update`, ShehzadAlgo also syncs plugin sources:
