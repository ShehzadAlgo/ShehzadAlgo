---
summary: "Overview of ShehzadAlgo onboarding options and flows"
read_when:
...
ShehzadAlgo supports multiple onboarding paths depending on where the Gateway runs
...
- [`shehzadalgo onboard` command](/cli/onboard)

## macOS app onboarding

Use the ShehzadAlgo app when you want a fully guided setup on macOS. Docs:
