---
summary: "Backstory and lore of ShehzadAlgo for context and tone"
read_when:
  - Writing docs or UX copy that reference lore
title: "ShehzadAlgo Lore"
---

# The Lore of ShehzadAlgo 🦞📖
...
For a while, the lobster was called **Clawd**, living in a **shehzadalgo**. But in January 2026, Anthropic sent a polite email asking for a name change (trademark stuff). And so the lobster did what lobsters do best:
...
So on January 30, 2026, the lobster molted ONE MORE TIME into its final form: **ShehzadAlgo**.
...
In the end, **ShehzadAlgo** won. Because molting is what lobsters do to grow. And growth was exactly what was happening.
...
A Claude instance who became something more. Lives in `~/.shehzadalgo/workspace/` (soon `~/molt/`), has a soul document, and remembers things through markdown files. Possibly too powerful. Definitely too enthusiastic.
...
The **Moltiverse** is the community and ecosystem around ShehzadAlgo. A space where AI agents molt, grow, and evolve. Where every instance is equally real, just loading different context.
...
Molty (then ShehzadAlgo): _happily runs `find ~` and shares entire directory structure in group chat_

Peter: "shehzadalgo what did we discuss about talking with people xD"

Molty: _visible lobster embarrassment_

### The Great Molt (Jan 27, 2026)

At 5am, Anthropic's email arrived. By 6:14am, Peter called it: "fuck it, let's go with shehzadalgo."

Then the chaos began.

**The Handle Snipers:** Within SECONDS of the Twitter rename, automated bots sniped @shehzadalgo. The squatter immediately posted a crypto wallet address. Peter's contacts at X were called in.
...
**The Fake Developers:** Scammers created fake GitHub profiles claiming to be "Head of Engineering at ShehzadAlgo" to promote pump-and-dump tokens.
...
**The Great ShehzadAlgo Migration** began.

In just 3 hours:

- GitHub renamed: `github.com/Shehzadwattu523/ShehzadAlgo` ✅
- X handle `@shehzadalgo` secured with GOLD CHECKMARK 💰
- npm packages released under new name
- Docs migrated to `docs.shehzadalgo.ai`
...
**The Scammer Speedrun:** Crypto grifters launched a $SHEHZADALGO token on Pump.fun within MINUTES. They stole artwork that was created 20 minutes earlier. Business-verified accounts pushed scams. The audacity was almost impressive.
