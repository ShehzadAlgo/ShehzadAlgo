---
summary: "Hubs that link to every ShehzadAlgo doc"
read_when:
...
<Note>
If you are new to ShehzadAlgo, start with [Getting Started](/start/getting-started).
</Note>
...
- [ShehzadAlgo assistant](/start/shehzadalgo)
