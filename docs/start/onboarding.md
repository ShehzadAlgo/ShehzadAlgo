---
summary: "First-run onboarding flow for ShehzadAlgo (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give ShehzadAlgo">
...
<Step title="CLI">
  ...
  The app can install the global `shehzadalgo` CLI via npm/pnpm so terminal
