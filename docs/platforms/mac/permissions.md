...
- Same path: run the app from a fixed location (for ShehzadAlgo, `dist/ShehzadAlgo.app`).
...
Workaround: move files into the ShehzadAlgo workspace (`~/.shehzadalgo/workspace`) if you want to avoid per-folder grants.
