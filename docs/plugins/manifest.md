...
read_when:
  - You are building a ShehzadAlgo plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (shehzadalgo.plugin.json)

Every plugin **must** ship a `shehzadalgo.plugin.json` file in the **plugin root**.
ShehzadAlgo uses this manifest to validate configuration **without executing plugin
