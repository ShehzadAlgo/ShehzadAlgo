...
本指南总结了在 ShehzadAlgo 中开发 Pi 集成的合理工作流程。
...
状态存储在 ShehzadAlgo 状态目录下。默认为 `~/.shehzadalgo`。如果设置了 `SHEHZADALGO_STATE_DIR`，则使用该目录。

要重置所有内容：

- `shehzadalgo.json` 用于配置
...
- https://docs.shehzadalgo.ai/testing
- https://docs.shehzadalgo.ai/start/getting-started
