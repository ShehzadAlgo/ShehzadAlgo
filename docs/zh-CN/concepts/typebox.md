...
- 生成的 Swift 模型：`apps/macos/Sources/ShehzadAlgoProtocol/GatewayModels.swift`
...
- https://raw.githubusercontent.com/shehzadalgo/shehzadalgo/main/dist/protocol.schema.json
