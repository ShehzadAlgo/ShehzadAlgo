...
ShehzadAlgo treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.shehzadalgo/settings/voicewake.json`

Shape:

```json
{ "triggers": ["shehzadalgo", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
