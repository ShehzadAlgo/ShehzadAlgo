...
shehzadalgo system heartbeat last
shehzadalgo logs --follow
shehzadalgo config get agents.defaults.heartbeat
shehzadalgo channels status --probe
```
...
```bash
shehzadalgo config get agents.defaults.heartbeat.activeHours
shehzadalgo config get agents.defaults.heartbeat.activeHours.timezone
shehzadalgo config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
shehzadalgo cron list
shehzadalgo logs --follow
```
