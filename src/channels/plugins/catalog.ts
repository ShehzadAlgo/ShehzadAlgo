...
import { discoverShehzadAlgoPlugins } from "../../plugins/discovery.js";
import type { ShehzadAlgoPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, ShehzadAlgoPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["shehzadalgo_PLUGIN_CATALOG_PATHS", "shehzadalgo_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<ShehzadAlgoPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: ShehzadAlgoPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: ShehzadAlgoPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverShehzadAlgoPlugins({ workspaceDir: options.workspaceDir });
