...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.shehzadalgo_DEBUG_TELEGRAM_ACCOUNTS)) {
...
function listConfiguredAccountIds(cfg: ShehzadAlgoConfig): string[] {
...
export function listTelegramAccountIds(cfg: ShehzadAlgoConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: ShehzadAlgoConfig): string {
...
function mergeTelegramAccountConfig(cfg: ShehzadAlgoConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: ShehzadAlgoConfig): ResolvedTelegramAccount[] {
