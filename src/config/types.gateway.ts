...
export type WideAreaDiscoveryConfig = {
  enabled?: boolean;
  /** Optional unicast DNS-SD domain (e.g. "shehzadalgo.internal"). */
  domain?: string;
};
...
export type CanvasHostConfig = {
  enabled?: boolean;
  /** Directory to serve (default: ~/.shehzadalgo/workspace/canvas). */
  root?: string;
...
export type GatewayControlUiConfig = {
  ...
  enabled?: boolean;
  /** Optional base path prefix for the Control UI (e.g. "/shehzadalgo"). */
  basePath?: string;
 ...
 * Used when shehzadalgo runs behind an identity-aware proxy (Pomerium, Caddy + OAuth, etc.)
