...
describe("createShehzadAlgoCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createShehzadAlgoCodingTools({
      config,
    ...
    const anthropicTools = createShehzadAlgoCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createShehzadAlgoCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createShehzadAlgoCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
