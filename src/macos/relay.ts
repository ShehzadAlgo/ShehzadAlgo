...
async function main() {
  ...
  const { ensureShehzadAlgoCliOnPath } = await import("../infra/path-env.js");
  ...
  process.on("uncaughtException", (error) => {
    console.error("[shehzadalgo] Uncaught exception:", formatUncaughtError(error));
    process.exit(1);
  });
