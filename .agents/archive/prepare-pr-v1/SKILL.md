...
- `fix: <summary> (shehzadalgo#<PR>) thanks @<author>`

```sh
commit_msg="fix: <summary> (shehzadalgo#$pr_number) thanks @$contrib"
...
echo "$subject" | rg -q "shehzadalgo#$pr_number" || { echo "ERROR: commit subject missing shehzadalgo#$pr_number"; exit 1; }
