      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["shehzadalgo gateway run", "Run the gateway in the foreground."],
            ["shehzadalgo gateway status", "Show service status and probe reachability."],
            ["shehzadalgo gateway discover", "Find local and wide-area gateway beacons."],
            ["shehzadalgo gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.shehzadalgo.ai/cli/gateway")}\n`,
      ),
  );
