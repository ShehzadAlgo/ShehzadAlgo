...
export function registerBrowserFilesAndDownloadsCommands(
  ...
  browser
    ...
    .argument(
      "<paths...>",
      "File paths to upload (must be within ShehzadAlgo temp uploads dir, e.g. /tmp/shehzadalgo/uploads/file.pdf)",
    )
  ...
  browser
    ...
    .argument(
      "[path]",
      "Save path within shehzadalgo temp downloads dir (default: /tmp/shehzadalgo/downloads/...; fallback: os.tmpdir()/shehzadalgo/downloads/...)",
    )
    .option("--target-id <id>", "CDP target id (or unique prefix)")
    .option(
      "--timeout-ms <ms>",
  ...
  browser
    ...
    .argument(
      "<path>",
      "Save path within shehzadalgo temp downloads dir (e.g. report.pdf or /tmp/shehzadalgo/downloads/report.pdf)",
    )
    .option("--target-id <id>", "CDP target id (or unique prefix)")
    .option(
      "--timeout-ms <ms>",
