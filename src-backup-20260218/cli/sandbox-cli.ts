...
const SANDBOX_EXAMPLES = {
  main: [
    ["shehzadalgo sandbox list", "List all sandbox containers."],
    ["shehzadalgo sandbox list --browser", "List only browser containers."],
    ["shehzadalgo sandbox recreate --all", "Recreate all containers."],
    ["shehzadalgo sandbox recreate --session main", "Recreate a specific session."],
    ["shehzadalgo sandbox recreate --agent mybot", "Recreate agent containers."],
    ["shehzadalgo sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["shehzadalgo sandbox list", "List all sandbox containers."],
    ["shehzadalgo sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["shehzadalgo sandbox recreate --all", "Recreate all containers."],
    ["shehzadalgo sandbox recreate --session main", "Recreate a specific session."],
    ["shehzadalgo sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["shehzadalgo sandbox recreate --browser --all", "Recreate only browser containers."],
    ["shehzadalgo sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["shehzadalgo sandbox explain", "Show effective sandbox config."],
    ["shehzadalgo sandbox explain --session agent:main:main", "Explain a specific session."],
    ["shehzadalgo sandbox explain --agent work", "Explain an agent sandbox."],
    ["shehzadalgo sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.shehzadalgo.ai/cli/sandbox")}\n`,
    )
    .action(() => {
