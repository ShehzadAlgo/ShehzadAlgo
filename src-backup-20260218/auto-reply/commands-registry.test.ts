...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@shehzadalgo", { botUsername: "shehzadalgo" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@shehzadalgo args", {
        botUsername: "shehzadalgo",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@shehzadalgo: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "shehzadalgo" })).toBe(
      "/help@otherbot",
    );
  });
