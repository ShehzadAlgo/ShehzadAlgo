...
export async function prependSystemEvents(params: {
  ...
  const resolveSystemEventTimezone = (cfg: ShehzadAlgoConfig) => {
  ...
  const formatSystemEventTimestamp = (ts: number, cfg: ShehzadAlgoConfig) => {
...
export async function ensureSkillSnapshot(params: {
  ...
  if (process.env.SHEHZADALGO_TEST_FAST === "1") {
