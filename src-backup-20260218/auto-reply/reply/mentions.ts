...
function resolveMentionPatterns(cfg: ShehzadAlgoConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: ShehzadAlgoConfig | undefined, agentId?: string): RegExp[] {
