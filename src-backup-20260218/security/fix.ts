...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof ShehzadAlgoConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: ShehzadAlgoConfig; env: NodeJS.ProcessEnv }): {
  cfg: ShehzadAlgoConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
