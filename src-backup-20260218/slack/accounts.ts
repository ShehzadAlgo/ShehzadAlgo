...
function mergeSlackAccountConfig(cfg: ShehzadAlgoConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: ShehzadAlgoConfig): ResolvedSlackAccount[] {
