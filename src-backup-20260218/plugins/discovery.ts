...
import {
  ...
  type ShehzadAlgoPackageManifest,
...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @shehzadalgo/voice-call -> voice-call).
...
export function discoverShehzadAlgoPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".shehzadalgo", "extensions")];
