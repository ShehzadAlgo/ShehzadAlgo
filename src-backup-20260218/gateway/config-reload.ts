...
import type { ShehzadAlgoConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: ShehzadAlgoConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: ShehzadAlgoConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: ShehzadAlgoConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: ShehzadAlgoConfig) => void;
  log: {
