...
import { type ShehzadAlgoConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: ShehzadAlgoConfig): string[] {
...
export function listAgentsForGateway(cfg: ShehzadAlgoConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: ShehzadAlgoConfig): string {
...
function resolveSessionStoreAgentId(cfg: ShehzadAlgoConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: ShehzadAlgoConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: ShehzadAlgoConfig): GatewaySessionsDefaults {
