...
export function applyVercelAiGatewayProviderConfig(cfg: ShehzadAlgoConfig): ShehzadAlgoConfig {
...
export function applyVercelAiGatewayConfig(cfg: ShehzadAlgoConfig): ShehzadAlgoConfig {
