...
function resolveDefaultAccountId(cfg: ShehzadAlgoConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: ShehzadAlgoConfig): boolean {
...
export function summarizeBindings(cfg: ShehzadAlgoConfig, bindings: AgentBinding[]): string[] {
