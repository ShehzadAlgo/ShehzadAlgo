...
export function applyLitellmProviderConfig(cfg: ShehzadAlgoConfig): ShehzadAlgoConfig {
...
export function applyLitellmConfig(cfg: ShehzadAlgoConfig): ShehzadAlgoConfig {
