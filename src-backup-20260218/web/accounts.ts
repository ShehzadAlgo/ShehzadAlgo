...
export function listWhatsAppAuthDirs(cfg: ShehzadAlgoConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: ShehzadAlgoConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: ShehzadAlgoConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: ShehzadAlgoConfig): ResolvedWhatsAppAccount[] {
