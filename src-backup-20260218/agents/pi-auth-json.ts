...
/**
 * Convert an ShehzadAlgo auth-profiles credential to pi-coding-agent auth.json format.
 ...
 *
 * ShehzadAlgo stores credentials in auth-profiles.json instead. This helper
