...
function resolveWatchPaths(workspaceDir: string, config?: ShehzadAlgoConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: ShehzadAlgoConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: ShehzadAlgoConfig }) {
