...
export const DEFAULT_SANDBOX_IMAGE = "shehzadalgo-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "shehzadalgo-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "shehzadalgo-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "shehzadalgo-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "shehzadalgo-sbx-browser-";
