...
describe("buildSandboxCreateArgs", () => {
  it("includes hardening and resource flags", () => {
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        "create",
        "--name",
        "shehzadalgo-sbx-test",
        "--label",
        "shehzadalgo.sandbox=1",
        "--label",
        "shehzadalgo.sessionKey=main",
        "--label",
        "shehzadalgo.createdAtMs=1700000000000",
        "--label",
        "shehzadalgo.sandboxBrowser=1",
        "--read-only",
        "--tmpfs",
        "/tmp",
        "--network",
  ...
  it("throws on dangerous bind mounts (Docker socket)", () => {
    ...
    expect(() =>
      buildSandboxCreateArgs({
        name: "shehzadalgo-sbx-dangerous",
        cfg,
        scopeKey: "main",
        createdAtMs: 1700000000000,
      }),
  ...
  it("throws on dangerous bind mounts (parent path)", () => {
    ...
    expect(() =>
      buildSandboxCreateArgs({
        name: "shehzadalgo-sbx-dangerous-parent",
        cfg,
        scopeKey: "main",
        createdAtMs: 1700000000000,
      }),
