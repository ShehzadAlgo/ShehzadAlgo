...
export function resolveDefaultAgentWorkspaceDir(
  ...
  const profile = env.SHEHZADALGO_PROFILE?.trim();
  if (profile && profile.toLowerCase() !== "default") {
    return path.join(home, ".shehzadalgo", `workspace-${profile}`);
  }
  return path.join(home, ".shehzadalgo", "workspace");
}
...
const WORKSPACE_STATE_DIRNAME = ".shehzadalgo";
