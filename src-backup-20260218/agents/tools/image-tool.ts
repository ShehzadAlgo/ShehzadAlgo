...
function resolveDefaultModelRef(cfg?: ShehzadAlgoConfig): {
  provider: string;
  model: string;
} {
  if (cfg) {
...
function pickMaxBytes(cfg?: ShehzadAlgoConfig, maxBytesMb?: number): number | undefined {
...
async function runImagePrompt(params: {
  ...
  const effectiveCfg: ShehzadAlgoConfig | undefined = params.cfg
    ? {
        ...params.cfg,
        agents: {
          ...params.cfg.agents,
  ...
  await ensureShehzadAlgoModelsJson(effectiveCfg, params.agentDir);
