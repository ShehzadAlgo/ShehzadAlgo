...
function mergeSignalAccountConfig(cfg: ShehzadAlgoConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: ShehzadAlgoConfig): ResolvedSignalAccount[] {
