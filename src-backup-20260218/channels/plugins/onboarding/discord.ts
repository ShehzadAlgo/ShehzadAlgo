...
function setDiscordDmPolicy(cfg: ShehzadAlgoConfig, dmPolicy: DmPolicy) {
...
function setDiscordAllowFrom(cfg: ShehzadAlgoConfig, allowFrom: string[]): ShehzadAlgoConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
