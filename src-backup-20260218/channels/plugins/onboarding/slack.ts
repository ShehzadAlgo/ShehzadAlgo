...
function setSlackDmPolicy(cfg: ShehzadAlgoConfig, dmPolicy: DmPolicy) {
...
function buildSlackManifest(botName: string) {
  const safeName = botName.trim() || "ShehzadAlgo";
  const manifest = {
    display_information: {
      name: safeName,
      description: `${safeName} connector for ShehzadAlgo`,
    },
    features: {
      bot_user: {
...
function setSlackAllowFrom(cfg: ShehzadAlgoConfig, allowFrom: string[]): ShehzadAlgoConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
